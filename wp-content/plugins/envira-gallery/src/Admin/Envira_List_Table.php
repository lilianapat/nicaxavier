...
<p class="search-box">
	...
	protected function pagination( $which ) {
		...
		$current_url = set_url_scheme( 'https://' . sanitize_text_field( wp_unslash( $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ) ) );
	...
	public function print_column_headers( $with_id = true ) {
		...
		$current_url     = ( ! empty( $_SERVER['HTTP_HOST'] && ! empty( $_SERVER['REQUEST_URI'] ) ) ) ? set_url_scheme( 'https://' . sanitize_text_field( wp_unslash( $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] ) ) ) : '';
