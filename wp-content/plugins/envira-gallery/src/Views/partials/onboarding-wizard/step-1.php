...
?>
	<div class="envira-onboarding-form-step envira-onboarding-form-step-active" id="general">
		...
		<div class="envira-onboarding-wizard-body">
			<div class="steps"><?php esc_html_e( 'Step - 1 of 5', 'envira-gallery' ); ?></div>
			<div class="envira-onboarding-settings-row no-padding no-border">
				<div class="settings-name">
					<h2><?php esc_html_e( 'What best describes you?', 'envira-gallery' ); ?></h2>
					<div class="name small-margin">
					</div>
					<div class="envira-onboarding-description"><?php esc_html_e( 'Tell us a bit about this website to help us craft the perfect experience for you.', 'envira-gallery' ); ?></div>
				</div>
					...
					<div class="envira-onboarding-input">
						<div class="envira-options">
							<div class="envira-option">
								...
								<label for="photographer"><?php esc_html_e( 'Photographer / Artist', 'envira-gallery' ); ?></label>
							</div>
							<div class="envira-option">
								<input type="radio" required id="web_developer" name="eow[_user_type]" value="dev-designer">
								<label for="web_developer"><?php esc_html_e( 'Web Developer / Designer', 'envira-gallery' ); ?></label>
							</div>
							<div class="envira-option">
								<input type="radio" required id="marketer" name="eow[_user_type]" value="marketer">
								<label for="marketer"><?php esc_html_e( 'Marketer', 'envira-gallery' ); ?></label>
							</div>
							<div class="envira-option">
								<input type="radio" required id="blogger" name="eow[_user_type]" value="blogger">
								<label for="blogger"><?php esc_html_e( 'Blogger', 'envira-gallery' ); ?></label>
							</div>
							<div class="envira-option">
								<input type="radio" required id="business_store_owner" name="eow[_user_type]" value="business-owner">
								<label for="business_store_owner"><?php esc_html_e( 'Business Store Owner', 'envira-gallery' ); ?></label>
							</div>
							<div class="envira-option">
								<input type="radio" required id="something_else" name="eow[_user_type]" value="other">
								<label for="something_else"><?php esc_html_e( 'Something Else', 'envira-gallery' ); ?></label>
							</div>
						</div>
						<div class="envira-options" id="others_div" style="display: none;">
							<input type="text" id="others" name="eow[_others]" value="<?php echo esc_attr( $onboarding->get_onboarding_data( '_others' ) ); ?>" placeholder="<?php esc_attr_e( 'What best describes you?', 'envira-gallery' ); ?>">
					</div>
					</div>
				</div>
				<div class="settings-name">
					<div class="name small-margin">
						<?php esc_html_e( 'Join Envira Community', 'envira-gallery' ); ?>
					</div>
					...
					<div class="envira-onboarding-input">
						<div class="envira-options">
							<div class="envira-option width-20">
								<label for="email_address"><?php esc_html_e( 'Email Address', 'envira-gallery' ); ?></label>
							</div>
					...
					<div class="envira-onboarding-input-container" style="margin-top: -20px;">
						<div class="envira-onboarding-input">
							<div class="envira-options email_opt_in">
								...
								<label for="email_opt_in"><?php esc_html_e( 'I agree to receive important communications from Envira Gallery.', 'envira-gallery' ); ?></label>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="envira-options envira-checkbox">
							<label class="envira-toggle">
								...
								<span class="description " >
									<?php esc_html_e( 'Help us better understand our users and their website needs.', 'envira-gallery' ); ?>
								</span>
							</label>
								<div class="tooltip-container" >
									...
									<span class="tooltip-text"><?php esc_html_e( 'If enabled EnviraGallery  will send some non-identifiable information about your WordPress site like what plugins and themes you use and which Envira Gallery settings you use to us so that we can improve our product.', 'envira-gallery' ); ?></span>
								</div>
						</div>
					</div>
				</div>
		...
		<div class="envira-onboarding-wizard-footer">
				<div class="go-back"><a href="#welcome" class="envira-onboarding-wizard-back-btn" id="envira-onboarding-back-to-welcome">←&nbsp;<?php esc_html_e( 'Go back', 'envira-gallery' ); ?></a></div>
				<div class="spacer"></div><input type="submit" data-next="1" class="btn envira-onboarding-wizard-primary-btn envira-onboarding-btn-next " id="save-opt-in" value="<?php esc_attr_e( 'Save and Continue', 'envira-gallery' ); ?>&nbsp; →"/>
		</div>
		</form>
	</div>
<script>
