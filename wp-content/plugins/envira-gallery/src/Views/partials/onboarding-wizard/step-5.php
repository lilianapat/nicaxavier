...
<div class="envira-onboarding-form-step envira-wizard-success envira-onboarding-step-5" id="resources">
	<div class="envira-onboarding-wizard-body">
		<div class="steps"><?php esc_html_e( 'Step - 5 of 5', 'envira-gallery' ); ?></div>
		<div class="envira-onboarding-settings-row no-border ">
			<div class="settings-name">
				<h2><?php esc_html_e( 'Congratulations! Grab your photos and start uploading your beautiful gallery', 'envira-gallery' ); ?></h2>
				<div class="name small-margin">
				</div>
				<div class="envira-onboarding-description"><?php esc_html_e( 'Need Help? Here’s what to do next', 'envira-gallery' ); ?></div>
			</div>
		...
		<div class="actions">
			<div class="">
				...
				<div class="content">
					<div><a target="_blank" href="<?php echo esc_url( 'https://enviragallery.com/docs/creating-first-envira-gallery/?utm_source=WordPress&utm_campaign=enviraliteplugin&utm_medium=envira-wizard-success' ); ?>" title="<?php esc_attr_e( 'Read our Step by Step Guide to Create and Share your Gallery' ); ?>" ><?php esc_html_e( 'Read our Step by Step Guide to Create and Share your Gallery', 'envira-gallery' ); ?></a></div>
				</div>
			</div>
			<div class="">
				<div class="icon">
				...
				<div class="content">
					<div><a target="_blank" href="<?php echo esc_url( 'https://www.youtube.com/watch?v=F9_wOefuBaw' ); ?>" title="<?php esc_attr_e( 'Watch Guided tour of Envira Gallery' ); ?>" ><?php esc_html_e( 'Watch Guided tour of Envira Gallery', 'envira-gallery' ); ?></a></div>
				</div>
			</div>
			<div class="">
				<div class="icon">
				...
				<div class="content">
					<div><a target="_blank" href="<?php echo esc_url( 'https://www.wpbeginner.com/?utm_source=WordPress&utm_campaign=enviraliteplugin&utm_medium=envira-wizard-success' ); ?>" title="<?php esc_attr_e( 'Learn WordPress Tutorials' ); ?>" ><?php esc_html_e( 'Learn WordPress Tutorials', 'envira-gallery' ); ?></a></div>
				</div>
			</div>
		</div>
	</div>
	<div class="envira-onboarding-wizard-footer">
		<div class="go-back"><a href="#summary" data-prev="3" class="envira-onboarding-wizard-back-btn envira-onboarding-btn-prev" id="" >←&nbsp;<?php esc_html_e( 'Go back', 'envira-gallery' ); ?></a></div>
		<div class="spacer"></div>
		<a class="btn btn-transparent" href="<?php echo esc_url( admin_url( '/edit.php?post_type=envira&page=envira-gallery-settings' ) ); ?>"><?php esc_html_e( 'Go to settings', 'envira-gallery' ); ?></a>
		<a class="btn envira-onboarding-wizard-primary-btn" href="<?php echo esc_url( admin_url( '/post-new.php?post_type=envira' ) ); ?>"><?php esc_html_e( 'Create your first gallery', 'envira-gallery' ); ?>&nbsp; →</a>
	</div>
</div>
