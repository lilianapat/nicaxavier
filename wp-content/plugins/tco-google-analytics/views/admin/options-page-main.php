    ...
    <div id="meta-box-settings" class="postbox" style="display: <?php echo ( isset( $tco_google_analytics_enable ) && $tco_google_analytics_enable == 1 ) ? 'block' : 'none'; ?>;">
      ...
      <div class="inside">
        ...
        <table class="form-table">
          ...
          <tr>
            <th>
              <label for="tco_google_analytics_id">
          ...
          <tr>
            <th>
              <label for="tco_google_analytics_id">
                <strong><?php _e( 'Implementation', '__tco__' ); ?></strong>
                <span><?php _e( 'Select implementation, can be either standard google analytics, or as google tag manager.', '__tco__' ); ?></span>                
              </label>
            </th>
            <td>
            <fieldset>
                <legend class="screen-reader-text"><span>input type="radio"</span></legend>
                <label class="radio-label"><input type="radio" class="radio" name="tco_google_analytics_implementation" value="ga" <?php echo ( isset( $tco_google_analytics_implementation ) && checked( $tco_google_analytics_implementation, 'ga', false ) ) ? checked( $tco_google_analytics_implementation, 'ga', false ) : 'checked="checked"'; ?>> <span><?php _e( 'ga (standard)', '__tco__' ); ?></span></label><br>
                <label class="radio-label"><input type="radio" class="radio" name="tco_google_analytics_implementation" value="gtag" <?php echo ( isset( $tco_google_analytics_implementation ) && checked( $tco_google_analytics_implementation, 'gtag', false ) ) ? checked( $tco_google_analytics_implementation, 'gtag', false ) : ''; ?>> <span><?php _e( 'gtag.js', '__tco__' ); ?></span></label>
              </fieldset>           	
            </td>
          </tr>
          ...
          <tr>
            <th>
              <label for="tco_google_analytics_track_all">
                <strong><?php _e( 'Include logged-in users.', '__tco__' ); ?></strong>
                <span><?php _e( 'By default google analytics only tracks non logged in users. By checking this it will include logged in users.', '__tco__' ); ?></span>                
              </label>
            </th>
            <td>
              <fieldset>
                <legend class="screen-reader-text"><span>input type="checkbox"</span></legend>
                <input type="checkbox" class="checkbox" name="tco_google_analytics_track_all" id="tco_google_analytics_track_all" value="1" <?php checked( ! isset( $tco_google_analytics_track_all ) ? '0' : $tco_google_analytics_track_all, '1', true ); ?>>
              </fieldset>
            </td>
          </tr>
