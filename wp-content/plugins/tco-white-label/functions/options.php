...
if ( isset( $_POST['tco_white_label_form_submitted'] ) ) {
  if ( strip_tags( $_POST['tco_white_label_form_submitted'] ) == 'submitted' && current_user_can( 'manage_options' ) && current_user_can( 'manage_options' ) && isset($_POST['tco_white_label_noncename']) && wp_verify_nonce( $_POST['tco_white_label_noncename'], 'tco_white_label' )) {
